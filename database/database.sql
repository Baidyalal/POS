...
('company', 'Open Source Point of Sale, Inc'),
('default_tax_rate', '8'),
...
CREATE TABLE `ospos_people` (
 `person_id` int(10) not null auto_increment, PRIMARY KEY (`person_id`),
 `person_type` int(1) NOT NULL,
 `update_date` date NOT NULL,
  `person_title` int(1) NOT NULL,
...
INSERT INTO `ospos_people` (`person_id`,`person_type`,`update_date`,`person_title`,`first_name`, `last_name`, `phone_number`, `email`, `address_1`, `address_2`, `city`, `state`, `zip`, `country`, `comments` ) VALUES
('1','1','2011-07-11','1','John', 'Doe', '555-555-5555', 'admin@pappastech.com', 'Address-1', 'Address-2', '', '', '', '', '');
