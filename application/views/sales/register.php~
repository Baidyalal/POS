...
<div id="new_item_button_register">
	...
	{ echo anchor("sales/new_sale/width:360",
	"<div class='small_button'><span style='font-size:73%;'>".$this->lang->line('sales_new_item')."</span></div>",
...
else
{
	...
	?>
		...
		<td><?php echo anchor("sales/edit_new_item/$line/width:360","<div class='small_button'><span style='font-size:73%;'>".$this->lang->line('sales_edit_item')."</span></div>",
	array('class'=>'thickbox none','title'=>$this->lang->line('sales_edit_item')));?></td>
		</tr>
		<tr>
		...
		<?php
        	if($item['is_serialized']==1)
        	{
        		echo form_input(array('name'=>'serialnumber','value'=>$item['item_number'],'size'=>'20'));
			}
			else
			{
...
<div id="overall_sale">
	...
	<div id='sale_details'>
		...
		<div class="float_left" style='width:55%;'><?php echo $this->config->item('default_tax_1_name');?>:</div>
		<div class="float_left" style="width:45%;font-weight:bold;"><?php echo to_currency($tax1); ?></div>

		<div class="float_left" style='width:55%;'><?php echo $this->config->item('default_tax_2_name');?>:</div>
		<div class="float_left" style="width:45%;font-weight:bold;"><?php echo to_currency($tax2); ?></div>
