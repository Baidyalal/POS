...
<div id="receipt_wrapper">
	...
	<td colspan="2" style='text-align:right;border-top:2px solid #000000;'><?php echo to_currency($subtotal); ?></td>
		...
		<tr>
			<td colspan="4" style='text-align:right;'><?php echo $this->lang->line('items_sales_tax_1').':';?></td>
			<td colspan="2" style='text-align:right;'><?php echo to_currency($item['price']*$item['quantity']/100); ?></td>
		</tr>

	<tr>
	<td colspan="4" style='text-align:right;'><?php echo $this->lang->line('items_sales_tax_2').':';?></td>
	<td colspan="2" style='text-align:right'><?php echo to_currency($item['price']*$item['quantity']/100); ?></td>
	</tr>
